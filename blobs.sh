...
# Git hased new staged file and wrote it as a blob
...
# Hash will be 3fa0d4b98289a95a7cd3a45c9545e622718f8d2b

# You can also manually hash object in git, not using procelain add.
# Command below will generate the same hash as one above
